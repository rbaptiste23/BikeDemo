...
//	}
	 ...
	 @Bean
	    public UserDetailsService userDetailsService() {
	        ...
	        manager.createUser(User.withDefaultPasswordEncoder().username("admin").password("test2").roles("ADMIN").build());
	        return manager;
	    }
	 ...
	 /* 
	   ...
	   The reason for this is that the WebSecurityConfigurerAdapter provides a default configuration
	   in the configure(HttpSecurity http) method that looks like:	     
	  * */
